...
TRENTO_SERVER_CHART_VERSION=${TRENTO_SERVER_CHART_VERSION:-"2.5.0"}
TRENTO_WEB_VERSION=${TRENTO_WEB_VERSION:-"2.5.0"}
TRENTO_WANDA_VERSION=${TRENTO_WANDA_VERSION:-"1.5.0"}
...
install_trento_server_chart() {
    ...
    local args=(
        ...
        --set global.trentoWeb.trentoWebOrigin="${TRENTO_WEB_ORIGIN}"
    )
