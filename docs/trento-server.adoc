...
[source,shell]
....
helm install trento . --set trento-mcp-server.enabled=true --set trento-mcp-server.mcpServer.trentoURL="https://<your-trento-url>" --set trento-mcp-server.mcpServer.oasPath[0]="https://<your-trento-url>/api/all/openapi"
....
